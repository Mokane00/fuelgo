import { Eye, EyeOff, Fuel, Lock, Mail } from 'lucide-react';
          ...
          <div className="relative card w-full max-w-sm animate-scale-in">
            ...
            {forgotStep === 'email' ? (
              <div className="space-y-4">
                <input id="forgot-email" name="forgot_email" type="email" className="input" placeholder="Your email" value={forgotEmail} onChange={e => setForgotEmail(e.target.value)} />
              ...
              <div className="space-y-4">
                <input id="forgot-code" name="forgot_code" type="text" className="input" placeholder="6-digit code" value={forgotCode} onChange={e => setForgotCode(e.target.value)} maxLength={6} />
                <input id="forgot-password" name="forgot_password" type="password" className="input" placeholder="New password" value={forgotPw} onChange={e => setForgotPw(e.target.value)} />
